      ...
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-100px' }}>
        ...
        <div className="about-content-grid" style={{ display: 'grid', gridTemplateColumns: 'minmax(280px, 1fr) 1.2fr', gap: '4rem', alignItems: 'start', maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <motion.div style={{ color: 'var(--text-primary)', fontFamily: "'Exo 2', sans-serif", fontSize: '1rem', fontWeight: 300, lineHeight: 1.9 }} variants={itemVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }}>
            <p style={{ marginBottom: '2rem' }}>Solutions Architect and technical advisor with 6+ years translating complex business requirements into scalable, secure system designs for Fortune 50 clients. Currently leading greenfield architecture projects from stakeholder discovery through delivery, including requirements gathering, architectural diagramming, and cross-functional presentation.</p>
            <p style={{ marginBottom: '2rem' }}>Deep hands-on background in system design trade-offs: evaluating monolith decomposition strategies, designing dual-auth API surfaces, selecting resilience patterns, and defending architectural decisions to engineering leadership and business stakeholders. Primary ecosystems are Java/Spring and .NET, with active work in AI agent development.</p>
            <p style={{ marginBottom: '2rem' }}>Hands-on with Azure and Kubernetes in production. Currently pursuing AZ-104 and AZ-305 (Azure Solutions Architect Expert path). AWS in the pipeline. Building with Claude API and Semantic Kernel for multi-agent systems. Comfortable at the whiteboard, in the IDE, and in front of the client.</p>
            <p style={{ marginBottom: '4rem', color: 'var(--text-muted)' }}>Advising on cloud architecture, leading enterprise modernization, and building AI-driven developer tools. Greater Seattle Area and remote. Direct hire only.</p>
