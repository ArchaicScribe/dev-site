      ...
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-100px' }}>
        ...
        <div className="about-content-grid" style={{ display: 'grid', gridTemplateColumns: 'minmax(280px, 1fr) 1.2fr', gap: '4rem', alignItems: 'start', maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <motion.div style={{ color: 'var(--text-primary)', fontFamily: "'Exo 2', sans-serif", fontSize: '1rem', fontWeight: 300, lineHeight: 1.9 }} variants={itemVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }}>
            <p style={{ marginBottom: '2rem' }}>Senior Software Engineer with 6+ years modernizing long-lived enterprise Java and .NET applications into maintainable Spring Boot architectures and cloud-ready deployments.</p>
            ...
            <p style={{ marginBottom: '4rem', color: 'var(--text-muted)' }}>Building enterprise-grade systems and secure APIs that scale. Targeting Seattle, the greater Boston area, and remote-first teams. Direct hire only.</p>
            <div className="about-stats-row" style={{ display: 'flex', gap: '4rem', paddingTop: '2rem', borderTop: '1px solid var(--ui-input-border)' }}>
              ...
              <div className="about-stat-item" style={statStyle}><span className="about-stat-value" style={{ fontFamily: "'Orbitron', sans-serif", fontSize: '1.75rem', fontWeight: 600, color: 'var(--accent-secondary)' }}>Q-Cleared</span><span className="about-stat-label" style={{ fontFamily: "'Exo 2', sans-serif", fontSize: '0.75rem', color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.1em' }}>DOE Security</span></div>
            </div>
          </motion.div>
        </div>
      </motion.div>
