...
export default function PaymentCardDiagram() {
    ...
    return (
        <div>
            ...
            >
                <defs>
                    <marker id="arrowCyan" markerWidth="8" markerHeight="8"
                    ...
                    <marker id="arrowGold" markerWidth="8" markerHeight="8"
                        refX="6" refY="3" orient="auto">
                        <path d="M 0 0 L 6 3 L 0 6"
                            stroke={C.gold} strokeWidth={1} fill="none" />
                    </marker>
                    <marker id="arrowSuccess" markerWidth="8" markerHeight="8"
                        refX="6" refY="3" orient="auto">
                        <path d="M 0 0 L 6 3 L 0 6"
                            stroke={C.success} strokeWidth={1} fill="none" />
                    </marker>
                    <marker id="arrowDanger" markerWidth="8" markerHeight="8"
                        refX="6" refY="3" orient="auto">
                        <path d="M 0 0 L 6 3 L 0 6"
                            stroke={C.danger} strokeWidth={1} fill="none" />
                    </marker>
                </defs>
