...
export const projects = [
  {
    ...
    description: 'Full-stack feature enabling internal associates to update a customer\'s default payment card through enterprise tooling. Includes UI, a new service endpoint, and downstream processor integration with async persistence.',
    fullCaseStudy: {
      ...
      decision: 'Built the complete vertical slice: associate-facing UI with optimistic updates and two distinct modal flows, a new REST endpoint with authentication, validation, and logging, and downstream integration to the payment processor with async DB persistence.',
