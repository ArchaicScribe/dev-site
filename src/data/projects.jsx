...
export const projects = [
  {
    ...
    description: 'Architected a full-stack feature enabling internal associates to update a customer\'s default payment card through enterprise tooling. Designed the UI, service endpoint, and downstream processor integration with async persistence.',
    fullCaseStudy: {
      problem: 'Associates had no way to update a customer\'s default payment card through internal tooling. The system had no endpoint to handle this operation, no UI to surface it, and no downstream integration to persist the change to the payment processor.',
      decision: 'Designed and delivered the complete vertical slice: associate-facing UI with optimistic updates and two distinct modal flows, a new REST endpoint with authentication, validation, and logging, and downstream integration to the payment processor with async DB persistence.',
      outcome: 'Feature currently under active development. UI layer and service endpoint complete. Downstream integration and async confirmation flow in progress. Default tag renders correctly and DB persistence confirmed in dev environment.',
    },
  ...
  },
  {
    ...
    fullCaseStudy: {
      ...
      decision: "Designed an incremental modernization path into Spring Boot 2.7.14 and Spring Cloud rather than a full rewrite, preserving business logic while introducing structured resilience patterns, proper logging via SLF4J/Logback, and clear service boundaries.",
  ...
  },
  {
    ...
    fullCaseStudy: {
      ...
      decision: "Designed dual Spring Security filter chains, each scoped to its authentication mechanism, with shared authorization rules applied downstream. Kept the chains independently testable and aligned to existing enterprise security controls.",
  ...
  },
  {
    ...
    description: 'Contributed to a large-scale federal web application tracking candidates through the government security clearance process (spanning L through Top Secret and above) under strict compliance and regulatory requirements. Built with C#/.NET, Blazor, and SQL Server.',
    fullCaseStudy: {
